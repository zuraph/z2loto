...
/*import Menejment  from './views/menejment/menejment';*/
import Transactions  from './views/transaction/transaction';
import Statistics  from './views/statistics/statistics';
import TransferProvider  from './views/transferProviders/transferProviders';
import SlotsProviders  from './views/slotsProviders/slotsProviders';
    ...
    render() {
        return (
            <>
                ...
                {/*<Route path="/menejment" component={Menejment} />*/}
                <Route path="/transactions" component={Transactions} />
                <Route path="/statistics" component={Statistics} />
                <Route path="/transferProviders" component={TransferProvider} />
                <Route path="/slotsProviders" component={SlotsProviders} />
